...
spec: brioela-specs/06-receipt-spend-intelligence.md
  ...
  → build-guide/13-receipt-intelligence/02-gpt4o-mini-vision-and-normalization.md [x] done
...
build-guide: build-guide/07-scanner/
  → build-guide/13-receipt-intelligence/01-receipt-ingestion.md [x] done (GPT-4o mini vision extraction reuse)
...
build-guide: build-guide/11-bela/
  → build-guide/13-receipt-intelligence/01-receipt-ingestion.md [x] done (receipt vision extraction reuse)
