...
spec: implementable-specs/cooking-session/02-cooking-agent.md
  → build-guide/08-cooking-session/02-cooking-agent-do.md    [x] done
...
spec: implementable-specs/cooking-session/07-transcript-storage.md
  → build-guide/08-cooking-session/02-cooking-agent-do.md    [x] done (turn counter from agent_state)
