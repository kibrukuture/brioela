...
| [ ] | `07-allergy-dislike-and-dietary-guardrails.md` | Allergy system, dietary restrictions, hard blocks vs soft guidance |
| [ ] | `08-personal-food-memory-engine.md` | User food memory — what they cook, buy, prefer, avoid |
| [ ] | `09-per-user-agent-orchestrator.md` | Orchestrator DO — the central agent, CRITICAL PATH for everything |
| [ ] | `10-voice-cooking-agent.md` | Voice cooking assistant — precursor to cooking session spec |
| [ ] | `11-live-vision-cooking-coach.md` | Camera-based cooking coach — precursor to cooking session spec |
| [ ] | `12-multi-person-cooking-rooms.md` | Multiple people in one cooking session |
| [ ] | `13-generational-recipe-capture.md` | Capturing family recipes from elders, voice, video |
...
| [ ] | `32-grandma-style-flavor-profile.md` | Capturing and recreating traditional/family flavor profiles |
| [ ] | `33-minimum-spend-meal-plan.md` | Budget meal planning — most nutrition for least cost |
| [ ] | `34-universal-visual-intake.md` | Visual food logging — photo → nutrition data |
...
| Status | File | One-line description |
|---|---|---|
| [ ] | `00-overview.md` | Implementable specs overview |
| [ ] | `01-memory-event.md` | Memory event schema — how events are logged |
| [ ] | `02-user-memory.md` | User memory table — key/value memory store |
| [ ] | `03-user-personality.md` | User personality model — how the AI understands the user |
| [ ] | `04-skills.md` | User cooking skills table |
| [ ] | `05-skill-versions.md` | Skill versioning — how skills evolve over time |
| [ ] | `06-constraints.md` | Constraint table — allergies, dietary rules, boycotts |
| [ ] | `07-sessions.md` | Session table — cooking sessions, scan sessions |
| [ ] | `08-session-turns.md` | Session turns — each exchange in a session |
| [ ] | `09-recipes.md` | Recipe table — user's saved recipes |
| [ ] | `10-scheduled-alarms.md` | DO alarm schedule — timer system |
| [ ] | `11-agent-state.md` | Agent state key/value store in DO SQLite |
| [ ] | `12-schema-version.md` | Schema migration versioning |
| [ ] | `13-gaps-and-missing-specs.md` | Known gaps — read to understand what is intentionally unspecced |
| [ ] | `15-curator.md` | Curator — background maintenance job (note: no file 14) |
| [ ] | `16-agent-identity.md` | Agent identity — who Brioela is, how it presents itself |
| [ ] | `17-session-lifecycle.md` | Full session lifecycle from open to close |
| [ ] | `18-vectorize.md` | Cloudflare Vectorize integration — semantic search |
...
| Status | File | One-line description |
|---|---|---|
| [ ] | `00-index.md` | Tool index — all tools listed |
| [ ] | `01-log-memory-event.md` | Tool: log a memory event |
| [ ] | `02-write-user-memory.md` | Tool: write to user memory |
| [ ] | `03-read-user-memory.md` | Tool: read from user memory |
| [ ] | `04-create-user-skill.md` | Tool: create a new skill record |
| [ ] | `05-update-user-skill.md` | Tool: update an existing skill |
| [ ] | `06-view-user-skill.md` | Tool: read a skill |
| [ ] | `07-archive-user-skill.md` | Tool: archive (soft-delete) a skill |
| [ ] | `08-delete-user-skill.md` | Tool: hard-delete a skill |
| [ ] | `09-propose-user-constraint.md` | Tool: AI proposes a new dietary constraint |
| [ ] | `10-confirm-user-constraint.md` | Tool: user confirms a proposed constraint |
| [ ] | `11-schedule-user-alarm.md` | Tool: set a cooking timer via DO alarm |
| [ ] | `12-cancel-user-alarm.md` | Tool: cancel a timer |
| [ ] | `13-view-user-recipe.md` | Tool: read a recipe |
| [ ] | `14-update-user-recipe.md` | Tool: update a recipe |
| [ ] | `15-archive-user-recipe.md` | Tool: archive a recipe |
| [ ] | `16-load-session-context.md` | Tool: load full user context at session start |
| [ ] | `17-search-session-history.md` | Tool: search past sessions |
| [ ] | `18-search-web.md` | Tool: web search from within a session |
...
| Status | File | One-line description |
|---|---|---|
| [ ] | `00-overview.md` | Cooking session system overview |
| [ ] | `01-room-lifecycle.md` | Room creation, joining, leaving — Cloudflare Realtime SFU |
| [ ] | `02-cooking-agent.md` | CookingAgent DO — main controller, in-memory state, endpoints |
| [ ] | `03-gemini-session.md` | Gemini 3.1 Flash Live WebSocket — setup, audio, video, tool calls |
| [ ] | `04-tool-protocol.md` | How Gemini tool calls are handled and forwarded |
| [ ] | `05-video-processing.md` | JPEG frame pipeline — mobile → SFU → DO → Gemini |
| [ ] | `06-timers.md` | Cooking timer system via DO alarms |
| [ ] | `07-transcript-storage.md` | Session transcript written to SQLite |
| [ ] | `08-session-end.md` | Clean session end, state flush, memory writes |
| [ ] | `09-reconnection.md` | Gemini reconnect logic, DO eviction recovery |
| [ ] | `10-human-behaviors.md` | Human-like AI behaviors — tone, hesitation, proactive observations |
| [ ] | `proactive-speech-engine/00-index.md` | Proactive speech engine overview |
| [ ] | `proactive-speech-engine/01-silence-tracker.md` | Tracks silence duration to decide when AI can speak |
| [ ] | `proactive-speech-engine/02-visual-change-detector.md` | Detects visual changes in camera feed |
| [ ] | `proactive-speech-engine/03-adaptive-frequency.md` | Adjusts how often AI speaks based on session context |
| [ ] | `proactive-speech-engine/04-prompt-builder.md` | Builds observation prompts sent to Gemini |
| [ ] | `proactive-speech-engine/05-response-filter.md` | Filters Gemini responses — suppresses "ok", passes real observations |
| [ ] | `proactive-speech-engine/06-suppression-rules.md` | Rules for when AI must not speak |
