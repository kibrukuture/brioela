...
## Status
**FIXED.** Shipped tools (memory, recipe, alarm) use split layout. Ledgers `0002`, `0003`, `0005`, `0006`, `0007` updated — monolithic proposed snippets removed; split contract + thin wrapper examples added.
