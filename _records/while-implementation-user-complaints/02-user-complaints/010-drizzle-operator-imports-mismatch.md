...
## Status
**FIXED.** Brain `_repositories/` / `_schemas/` import from `@/database/drizzle/_database` and `@/database/sqlite/_schema`. Ledgers `0002`, `0003`, `0005`, `0006` repo snippets updated — no `@brioela/shared/drizzle`.
