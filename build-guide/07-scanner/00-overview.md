...
Note: restaurant menu scanning has its own folder (`17-menu-scanning`) and reuses the OCR pipeline from this folder.
...
- `17-menu-scanning` — reuses OCR pipeline (enhance.image.helper.ts, Gemini Vision pattern)
