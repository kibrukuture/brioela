...
| `05-safety-and-tier-boundary.md` | hard allergy override, scan remains free, Luma tier teaser/upgrade behavior |
...
- Available on Luma and above; Sapor sees teaser + upgrade prompt
...
- `25-pricing-tiers` — uses Kids Mode as a Luma upgrade trigger; entitlement enforcement lives there
