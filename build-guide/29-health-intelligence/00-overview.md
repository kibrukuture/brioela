...
- **Health Agent is Brain-owned.** Started by the Brain from a `scheduled_alarms` row, runs a bounded pass, proposes/records results through Brain-owned capabilities, and never owns user SQLite truth.
