...
- `12-recall-alerts` — active recall_entry table checked for cross-reference
- `08-ground` — community illness signals appear as Ground notes
- `10-notifications` — follow-up alarm 24h after illness report
