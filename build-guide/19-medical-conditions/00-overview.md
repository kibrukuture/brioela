...
- `11-pantry-meal-plan` — meal plan filters against active conditions
- `17-wearables` — CGM + T2 diabetes is the most powerful combination in the app
- `07-cooking-session` — cooking agent aware of active conditions in session context
