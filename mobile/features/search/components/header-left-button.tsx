...
import { EDIT_HOME_CONTAINER_WIDTH } from '@/stores/ui/use-search-header-store';
import { Settings2 } from 'lucide-react-native';
import { simulatePress } from '@/features/search/components/simulate-press';

export const HeaderLeftButton: FC = () => {
  return (
    <Pressable
