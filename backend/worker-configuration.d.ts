/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.jsonc` (hash: d4160d98454a344ef2e57aca331b9d63)
// Runtime types generated with workerd@1.20260603.1 2026-06-03 nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_Env {
	...
	ZEPTOMAIL_PASSWORD: string;
	ZEPTOMAIL_SERVER_NAME: string;
	ZEPTOMAIL_USER_NAME: string;
	QSTASH_URL: string;
	QSTASH_TOKEN: string;
	...
	SUPERWALL_WEBHOOK_SECRET: string;
	SUPERWALL_HEADER_AUTH_TOKEN: string;
	...
	S3_URL: string;
	ALIGNLAB_API_KEY: string;
	SUPABASE_CA_CERT: string;
	BRIDGE_API_KEY: string;
	ZEPTOMAIL_URL: string;
	ZEPTOMAIL_TOKEN: string;
	POLYGON_ALCHEMY_URL: string;
	ALIGNLAB_SANDBOX_API_KEY: string;
	THIRD_WEB_CLIENT_ID: string;
	THIRD_WEB_API_SECRET: string;
	THIRD_WEB_SERVER_WALLET_ADDRESS: string;
	THIRD_WEB_SERVER_SMART_ACCOUNT_ADDRESS: string;
	THIRD_WEB_SERVER_WALLET_LABEL: string;
	RESEND_API_KEY: string;
	COURIER_AUTH_KEY: string;
	ONESIGNAL_APP_ID: string;
	ONESIGNAL_REST_API_KEY: string;
	ENCRYPTION_KEY: string;
	THIRD_WEB_CHAIN_ID: string;
	REDIS_API_KEY: string;
	REDIS_URL: string;
	REDIS_TOKEN: string;
	LOCATION_IQ_ACCESS_TOKEN: string;
	BRIOELA_BRAIN: DurableObjectNamespace<import("./src/index").BrioelaBrain>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BrioelaBrain";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY" | "SUPABASE_DATABASE_URL" | "SUPABASE_DATABASE_PASSWORD" | "DATABASE_CONNECTION_STRING" | "GEMINI_API_KEY" | "OPENAI_API_KEY" | "ZEPTOMAIL_PASSWORD" | "ZEPTOMAIL_SERVER_NAME" | "ZEPTOMAIL_USER_NAME" | "QSTASH_URL" | "QSTASH_TOKEN" | "QSTASH_CURRENT_SIGNING_KEY" | "QSTASH_NEXT_SIGNING_KEY" | "STRIPE_MONTHLY_PRICE_ID" | "STRIPE_YEARLY_PRICE_ID" | "STRIPE_PUBLISHABLE_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_SECRET_WEBHOOK_KEY" | "SUPERWALL_WEBHOOK_SECRET" | "SUPERWALL_HEADER_AUTH_TOKEN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "APPLE_CLIENT_ID" | "APPLE_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "SENTRY_DSN_BACKEND" | "ENVIRONMENT" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_BUCKET_NAME" | "S3_URL" | "ALIGNLAB_API_KEY" | "SUPABASE_CA_CERT" | "BRIDGE_API_KEY" | "ZEPTOMAIL_URL" | "ZEPTOMAIL_TOKEN" | "POLYGON_ALCHEMY_URL" | "ALIGNLAB_SANDBOX_API_KEY" | "THIRD_WEB_CLIENT_ID" | "THIRD_WEB_API_SECRET" | "THIRD_WEB_SERVER_WALLET_ADDRESS" | "THIRD_WEB_SERVER_SMART_ACCOUNT_ADDRESS" | "THIRD_WEB_SERVER_WALLET_LABEL" | "RESEND_API_KEY" | "COURIER_AUTH_KEY" | "ONESIGNAL_APP_ID" | "ONESIGNAL_REST_API_KEY" | "ENCRYPTION_KEY" | "THIRD_WEB_CHAIN_ID" | "REDIS_API_KEY" | "REDIS_URL" | "REDIS_TOKEN" | "LOCATION_IQ_ACCESS_TOKEN">> {}
}
