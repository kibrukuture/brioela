import { brainSchemaReadiness, type NewBrainSchemaReadiness } from '@/agents/brain/_schema'
import type { BrainDatabase } from '@/agents/brain/_database'

export function writeBrainSchemaReadiness(db: BrainDatabase, readiness: NewBrainSchemaReadiness): void {
	db
