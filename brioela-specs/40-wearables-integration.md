...
These facts are injected into session context via `buildMemoryContext()` (spec 09) — the Mira cooking scene, Mira voice scene, and scan pipeline all see this data without any additional fetch.
