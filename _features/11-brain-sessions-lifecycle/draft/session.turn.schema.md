# Draft: session.turn.schema.ts

Target: `backend/src/agents/brain/_schemas/session.turn.schema.ts`

**Shipped (04 foundation).** Turn **append** during live sessions is **20-brain-chat-runtime**; compression reads turns in **13**.
