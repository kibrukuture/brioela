# Draft: session.schema.ts

Target: `backend/src/agents/brain/_schemas/session.schema.ts`

**Shipped (04 foundation).** Feature **11** owns lifecycle write/read semantics on this table.
