# Draft: _lexicon/backend/cloudflare.lexicon.constant.ts

Target: `tools/brioela-lexicon-guard/_lexicon/backend/cloudflare.lexicon.constant.ts`

```typescript
import type { LexiconWord } from '../../_types'

export const backendCloudflareLexicon: LexiconWord[] = [
