...
**Migration status (docs only):** fully migrated — `04-brain-foundation`, `05-brain-memory-tools`, `06-brain-skill-tools`, `07-brain-constraint-tools`. All others: stub `status.md` unless noted.
