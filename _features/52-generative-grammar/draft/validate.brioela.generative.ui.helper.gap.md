# Draft: validate-brioela-generative-ui.ts (gap — file does not exist)

Target: `backend/src/core/generative-grammar/validate-brioela-generative-ui.ts`

**Gap (feature 52):** Server-side validation pipeline before streaming to client.
...
export function validateBrioelaGenerativeUi(input: unknown): ValidateResult {
	...
	// size caps: count nodes in content tree when layout embeds primitives
	void MAX_TOTAL_NODES
	void MAX_DEPTH
