# Draft: get.brain.tools.ts — production snapshot

Target: `backend/src/agents/brain/_tools/get.brain.tools.ts`

**As of migration audit.** 8 tools in `all` map; 10 public tools missing; permission drift vs canonical matrix (see `get.brain.tools.master-permissions.gap.md`).
